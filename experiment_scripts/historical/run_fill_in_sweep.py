...
DATASET_SIZE  = 1_000
N_FEATURES    = None
DATA_ROOT     = f"{DATA_ROOT}/{DATASET_BASE}/size_{DATASET_SIZE}"
...
FILL_IN_JOBS = [
    ...
    #("AIM", {"epsilon": 10.0}, "ARFFormer",            {}),
    ("AIM", {"epsilon": 10.0}, "CondDDPM",              {"retrain": True}),
    ("AIM", {"epsilon": 10.0}, "CondDDPMWithMLP",       {"retrain": False, "retrain_mlp": True}),
    ("AIM", {"epsilon": 10.0}, "CondRePaint",   {"retrain": False}),
    #("AIM", {"epsilon": 10.0}, "CondMST",           {"retrain": False}),
    #("AIM", {"epsilon": 10.0}, "CondMSTIndependent",{"retrain": False}),
    #("AIM", {"epsilon": 10.0}, "CondMSTBounded",    {"retrain": False, "max_clique_size": 3}),
