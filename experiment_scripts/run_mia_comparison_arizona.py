...
Run detached:
    nohup conda run -n recon_ python experiment_scripts/run_mia_comparison_arizona.py \
          > outfiles/mia_comparison_arizona.log 2>&1 &
"""
...
HOLDOUT_DIR   = f"{_DATA_DIR}/sample_02"
...
# QI_medium adds AGE, BPL, EMPSTAT, LABFORCE, HISPAN to QI1's 7 features.
# QI1 alone yields only 433 unique combinations in 10k records (avg 23 records/group),
# so the RF cannot distinguish individuals and RA-as-MIA is near-chance.
# QI_medium gives 5,769 unique combos (avg 1.7/group), comparable to adult QI1 (3,817).
QI         = "QI_medium"
DATA_TYPE  = "categorical"

# minus_QIs["nist_arizona_25feat"]["QI_medium"] hidden set (13 features):
#   CITIZEN, DURUNEMP, EDUC, FAMSIZE, FARM, GQ, INCWAGE, MARST,
#   MIGRATE5, NATIVITY, OWNERSHP, URBAN, WKSWORK1
# Exclude quasi-continuous: INCWAGE(2836), DURUNEMP(348), FAMSIZE(22), WKSWORK1(53)
# Keep discrete low-cardinality features for clean RA signal.
RA_HIDDEN_OVERRIDE = [
...
if __name__ == "__main__":
    ...
    wandb.init(
        ...
        name=f"compare_mia_ra_{DATASET}_qi_medium",
        config={
            "dataset": DATASET,
