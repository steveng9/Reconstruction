...
def main():
    ...
    ml_methods = {
        ...
        # "RF": random_forest_reconstruction,
...
def random_forest_reconstruction(deid, targets, qi, hidden_features):
    targets_copy = targets.copy()
    probas = []
    classes_ = []
    for hidden_feature in hidden_features:
...
def ensemble1_reconstruction(deid, targets, qi, hidden_features):
    targets_copy = targets.copy()
    for hidden_feature in hidden_features:
        rf_recon, rf_probas, rf_classes_ = random_forest_reconstruction(deid, targets, qi, [hidden_feature])
